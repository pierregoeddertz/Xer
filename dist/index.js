...
const Xer = (_a) => {
    ...
    const outerRef = require$$0.useRef(null);
    const [isDragging, setIsDragging] = require$$0.useState(false);
    const [isMouseDown, setIsMouseDown] = require$$0.useState(false);
    const startX = require$$0.useRef(0);
    const scrollLeft = require$$0.useRef(0);
    const velocity = require$$0.useRef(0);
    const dragThreshold = 10;
    const hasDraggedRef = require$$0.useRef(false);
    const animationFrameId = require$$0.useRef(null);
    // Touch Device Detection - nur für Custom Drag Logik
    const isTouchDevice = require$$0.useMemo(() => typeof window !== 'undefined' && 'ontouchstart' in window, []);
    ...
    const startInertiaScroll = require$$0.useCallback(() => {
    ...
    const dynamicStyles = require$$0.useMemo(() => {
        const styles = {};
    ...
    const ariaAttributes = require$$0.useMemo(() => ({
    ...
    const dataAttributes = require$$0.useMemo(() => ({
