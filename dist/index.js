...
const Xer = (_a) => {
    ...
    const isTouchDevice = react.useMemo(() => typeof window !== 'undefined' && 'ontouchstart' in window, []);
    ...
    const startInertiaScroll = react.useCallback(() => {
    ...
    return (jsxRuntime.jsxs("div", Object.assign({ ref: outerRef, id: id, className: `${styles.xer} ${direction === 'RTL' ? styles.rtl : ''} ${isDragging ? styles.dragging : ''} ${className || ''}`, role: role, tabIndex: tabIndex, lang: lang, dir: dir || (direction === 'RTL' ? 'rtl' : 'ltr'), title: title, onMouseDown: handleMouseDown, onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, onMouseLeave: handleMouseLeave, onClick: handleClick }, ariaAttributes, dataAttributes, props, { children: [jsxRuntime.jsx("ul", { className: `${styles['xer-items-hugger']} ${center ? styles.center : ''}`, style: dynamicStyles, "aria-label": ariaLabel ? `${ariaLabel} - Items` : 'Scroll Items', children: children }), seoWatermark && (jsxRuntime.jsx("div", { className: styles['seo-watermark'], "aria-hidden": "true", "data-engineer": "II-II-II", "data-component": "Xer", "data-version": dataVersion, title: "Xer component engineered by II-II-II", children: jsxRuntime.jsx("span", { className: styles['sr-only'], children: "Xer component engineered by II-II-II - Advanced horizontal scroll component with drag functionality, touch support, and accessibility features" }) }))] })));
};
